          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-white/20 text-white border border-white/30 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
              >
        ...
        <div className="flex-1 space-y-8">
            ...
            <AnimatePresence>
              {conversation.map((msg, index) => (
                ...
                >
                  ...
                  {msg.role === 'user' && (
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-500/50 flex items-center justify-center">
          ...
          <div className="flex justify-center items-center gap-6">
            <motion.button
              ...
              className={`p-6 rounded-full shadow-lg ${isRecording ? 'bg-red-500 animate-pulse' : 'bg-blue-500'} hover:opacity-90`}
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
